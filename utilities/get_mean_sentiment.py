...
if __name__ == '__main__':
    ...
    path_to_sentiment_sentistrength = '../_SentiStrength/results/sts_gold_tweets_senti_polarity.txt'
    path_to_sentiment_sentiwordnet = '../_SentiWordNet/results/sts_gold_tweets_senti_polarity.txt'
    path_to_sentiment_senticnet = '../_SenticNet/results/sts_gold_tweets_senti_polarity.txt'

    path_to_store_tweet_list_with_mean_sentiment = '../_combined/sts_gold_tweets_senti_polarity.txt'
