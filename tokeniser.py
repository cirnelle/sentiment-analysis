...
if __name__ == '__main__':
    ...
    samples = (
        "RT @highimkyrsten: @thexcity @LPscipG right!? 😂😂😂 #AutumnIn3Words #ApocalypseSky1  #MarsAnnouncement",
        )
    ...
    samples = (
        u"RT @ #happyfuncoding: this is a typical Twitter tweet :-), and this another one.",
